...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MARTE_DIR/../Build/x86-linux/Components/DataSources/StmIn/
...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MARTE_DIR/../Build/x86-linux/Components/GAMs/JemaGAM
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/opt/anaconda3/lib/
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MARTE_DIR/../Build/x86-linux/Components/DataSources/BaslerCamera
...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MARTE_DIR/../Build/x86-linux/Components/DataSources/SimulinkProxyIn
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$MARTE_DIR/../Build/x86-linux/Components/DataSources/SimulinkProxyOut
...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/opt/MARTe2/MARTe2-rfx-components/Build/x86-linux/Components/DataSources/EladIn
...
#valgrind --leak-check=full --show-leak-kinds=all $MARTe2_DIR/Docs/User/source/_static/examples/MARTeApp.sh -l RealTimeLoader $1 $2  $3 $4
