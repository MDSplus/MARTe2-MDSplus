...
//  gpctex1.cpp --
//
//      Simple Event Counting (or Countdown Timer)
//
...
void test(iBus *bus)
{
    ...
    */
    ...
    printf("GPCT0 value is now %ld %ld\n",readSaveRegGPCT0(board));
...
void simpleEventCountConfigGPCT0(tTIO *board, tMSeries *boardM)
{
	...
	board->G0_Input_Select.setG0_Source_Select(1); //see above for choices, PFI8=9, 100 kHZ=18
    ...
    board->G0_Mode.setG0_Gating_Mode(tTIO::tG0_Mode::kG0_Gating_ModeGating_Disabled); //kG0_Gating_ModeLevel_Gating
